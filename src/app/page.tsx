const Home = () => {
  return (
    <main className="flex flex-col items-center">
      <section className="py-32 sm:pb-80 xl:py-64 xl:pb-[30rem] px-8 xl:px-96 text-white bg-[url('/home-background.jpg')] bg-no-repeat bg-cover bg-center bg-overlay w-full text-center sm:text-left">
